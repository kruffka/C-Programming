...
Все примеры можно [найти тут](https://github.com/kruffka/C-Programming/blob/2025-2026/2_loops/src/)                 
            
Рассмотрим пару примеров с циклами, например поищем является ли число **простым** (делится только на себя и на 1).            

Рассмотрим [prime.c](https://github.com/kruffka/C-Programming/blob/2025-2026/2_loops/src/prime.c)              
