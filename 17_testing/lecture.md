- [Тестирование ПО (Software Testing)](#тестирование-по-software-testing)
  - [Жизненный цикл разработки ПО (SDLC)](#жизненный-цикл-разработки-по-sdlc)
  - [Тестирование ПО](#тестирование-по)
  - [Фазы тестирования](#фазы-тестирования)
  - [Основы модульного тестирования](#основы-модульного-тестирования)
    - [BDD](#bdd)
    - [Тесты - это тоже программа](#тесты---это-тоже-программа)
    - [Попробуем написать свои тесты (используя C и CMocka)](#попробуем-написать-свои-тесты-используя-c-и-cmocka)
      - [Список фреймворков для разных Языков Программирования](#список-фреймворков-для-разных-языков-программирования)
    - [CMocka](#cmocka)
      - [Инсталляция](#инсталляция)
      - [Линковка](#линковка)
    - [Unit тесты на cmocka](#unit-тесты-на-cmocka)
    - [CMocka форматтер](#cmocka-форматтер)
    - [Ctest форматтер](#ctest-форматтер)
      - [Function Mock в CMocka](#function-mock-в-cmocka)
    - [Code Coverage (Покрытие кода)](#code-coverage-покрытие-кода)
  - [CI/CD](#cicd)
