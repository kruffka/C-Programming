...
Это что-то типа поезда, только с ограничением: передвигаться по вагонам можно лишь в одну сторону.         
...
Пусть данные в односвязном списке будут числа (на лекции будут структуры котов) - создадим подобие целочисленного массива                   

<img src="img/cute-cat-jamming-to-music.gif" width ="200">                     
...
```
Полный пример кода тут в [singly_ll.c](https://github.com/kruffka/C-Programming/blob/2025-2026/14_linked_lists/src/singly_ll.c)              
...
![alt text](img/stack_examples.png)       
![alt text](img/queue_examples.png)             

##  3. <a name='3'></a>Двусвязный список

```c
// Многосвязный (двусвязный) список
node_t {
...
Двусвязный список - уже поезд из вагонов, в которых можно ходить в обе стороны..               

![alt text](img/doubly.png)                

Пример с кинцом [doubly_ll.c](https://github.com/kruffka/C-Programming/blob/2025-2026/14_linked_lists/src/doubly_ll.c):                

```bash
=== WATCH HISTORY ===
1. [ID: 1] Inception (148 min) - Rating: 8.8
2. [ID: 2] The Matrix (136 min) - Rating: 8.7
3. [ID: 3] Fight Club (139 min) - Rating: 8.9
4. [ID: 4] Interstellar (169 min) - Rating: 8.6
5. ▶ [ID: 5] Oppenheimer (180 min) - Rating: 8.5
6. [ID: 6] Barbie (114 min) - Rating: 7.0
7. [ID: 7] Poor Things (141 min) - Rating: 8.4
8. [ID: 8] Dune: Part Two (166 min) - Rating: 9.0
9. [ID: 9] The Batman (176 min) - Rating: 7.8
10. [ID: 10] Everything Everywhere All at Once (139 min) - Rating: 8.7
11. [ID: 11] Top Gun: Maverick (130 min) - Rating: 8.3
====================
```

Примеры использования:
- Кнопки "Назад" и "Вперед" в браузере
- "Плейлист в плеере"
- Ctrl+Z и Ctrl+Y (Отмена/Повтор)
- Алгоритмы кэширования (например, LRU)
- Дек (Deque - двусторонняя очередь), для эффективной вставки и удаления на обоих концах     

Дек:        
![alt text](img/deque.png)

##  4. <a name='4'></a>Циклический список

![alt text](./img/circular1.png)           
![alt text](./img/circular2.png)        
 
Самостоятельно: Как понять является список зацикленным?
...
Куда это применять? Первое что приходит в голову - переключение между персонажами в играх..          
