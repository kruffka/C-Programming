...
* 2. [Recursion](#2)
* 3. [Кадр ф-ии](#3)
* 4. [Аргументы в ф-ию](#4)
* 5. [int argc, char *argv[]](#5)
* 6. [Еще один dangling pointer](#6)
* 7. [Указатели на ф-ию](#7)
	* 7.1. [Массив указателей на функции](#7.1)
* 8. [variadic functions](#8)
* 9. [Callback](#9)
* 10. [API](#10)
...
Пример как вернуть значение через указатель:
```c
...
##  5. <a name='5'></a>int argc, char *argv[]
...
```bash
cowsay its the first day of the month
```
```bash
...
##  6. <a name='6'></a>Еще один dangling pointer
...
##  7. <a name='7'></a>Указатели на ф-ию
...
###  7.1. <a name='7.1'></a>Массив указателей на функции
...
##  8. <a name='8'></a>variadic functions
...
**ABI (Application Binary Interface)** — это низкоуровневое соглашение о том, как одна скомпилированная программа (уже в виде нулей и единиц) должна взаимодействовать с другой на уровне процессора и операционной системы.              
