<!-- vscode-markdown-toc -->
* 1. [Отладчик](#1)
* 2. [Компиляция программы для отладки](#2)
	* 2.1. [Пример 1](#2.1)
	* 2.2. [Пример 2](#2.2)
	* 2.3. [Пример 3](#2.3)
	* 2.4. [Пример 4](#2.4)
...
Продолжим отлаживать [пример ex1.c](https://github.com/kruffka/C-Programming/blob/2025-2026/11_gdb_valgrind/src/gdb_ex1.c):     
...
[Пример 2: ex2.c](https://github.com/kruffka/C-Programming/blob/2025-2026/11_gdb_valgrind/src/gdb_ex2.c)  
...
[Пример 3: ex3.c](https://github.com/kruffka/C-Programming/blob/2025-2026/11_gdb_valgrind/src/gdb_ex3.c)   
...
[Пример 4: ex4.c](https://github.com/kruffka/C-Programming/blob/2025-2026/11_gdb_valgrind/src/gdb_ex4.c)   
...
[Пример 5: ex5.c](https://github.com/kruffka/C-Programming/blob/2025-2026/11_gdb_valgrind/src/gdb_ex5.c)   
...
##  4. <a name='4'></a>Резиновая утка  
Здесь пару слов про резиновую утку и ее связь с отладкой.          
