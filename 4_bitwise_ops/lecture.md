...
Полный пример со всеми побитовыми операциями в [bitwise_ops.c](src/bitwise_ops.c)                 
...
Пример со сдвигами [shift.c](src/shift.c)               
...
Теперь, узнав побитовые операции, мы должны смочь вывести на экран с помощью printf значение в двоичном виде [printf_bin.c](src/printf_bin.c)             
