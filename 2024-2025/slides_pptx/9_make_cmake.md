...
Но не стоит забывать, что некоторые проекты используют различные библиотеки и зависимости, которые нужно отдельно устанавилвать. Такие вещи обычно также описываются в README.md проекта.     
