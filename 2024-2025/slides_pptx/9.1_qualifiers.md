...
Квалификаторы применяются при объявлении переменных и функций и указывают им некоторые свойства.   
Кратко здесь рассмотрим такие квалификаторы как: const, extern, static, restrict, volatile, restrict, auto, register.   
