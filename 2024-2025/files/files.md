...
В ОС есть разделение на области (кольца), в каждом из которых есть свой уровень привилегий для исполняемых программ. Самое внешнее кольцо - менее привилегированное, самое внутреннее наоборот. Самый высокий уровень привилегий у ядра. Реализуется в процессорах (процессор понимает с каким уровнем запускается программа)    
