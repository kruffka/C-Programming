...
Познавать С++ нужно с классики - «Язык программирования C++» (The C++ Programming Language) Бьерн Страуструп, он же создатель языка С++, дальше углубиться в ООП, STL (которые также в этой книге и в куче онлайн курсов описываются), читаем более современные книги по C++, опционально посмотреть потоки, а в конце изучать новвоведения и фишки стандартов C++11/17/20/23. Там появляется всякая move-семантика, корутины и т.д..
...
Пример: [namespace.cpp](https://github.com/kruffka/C-Programming/blob/570ce0ba5352aa8189caa0489910d7303f736868/18_cpp_basics/src/namespace.cpp)    
...
[class.cpp](https://github.com/kruffka/C-Programming/blob/570ce0ba5352aa8189caa0489910d7303f736868/18_cpp_basics/src/class.cpp)
